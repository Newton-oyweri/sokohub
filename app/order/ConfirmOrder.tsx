          ...
          <View style={styles.summaryContainer}>
            {checkingWallet ? (
              ...
              <>
                ...
                {/* Only shown if custom message/selection exists */}
                {Boolean(customWriting && customWriting.trim()) && (
                  <View style={styles.summaryRow}>
                    <Text style={styles.summaryLabel}>Message</Text>
                    <Text style={styles.summaryValue} numberOfLines={2}>{customWriting.trim()}</Text>
                  </View>
                )}
