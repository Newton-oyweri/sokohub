  ...
  return (
    <View style={styles.rootContainer}>
      ...
      >
        ...
        {/* Header Area with Live Counter Metric */}
        ...
        {/* SIMULATOR PIPELINE ACTION ROW */}
        <Pressable style={styles.testButton} onPress={simulateOrderTimeline}>
              ...
              >
                ...
                <View style={[styles.cardBodyContent, item.isRead && styles.dimmedBodyOpacity]}>
                  ...
                  <View style={styles.footerRow}>
                    {!item.isRead && (
                      <Text style={styles.tapPrompt}>Tap card to mark as read</Text>
                    )}
